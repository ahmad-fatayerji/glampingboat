...
export const dictionaries: Record<Locale, Dictionary> = {
  ...
  fr: {
    ...
    boatPlanDeck: "Pont",
    boatPlanElectricMotor: "Moteur electrique",
    boatPlanClearWater: "Pompage, filtration et desinfection de l'eau claire",
    boatPlanBlackWater: "Traitement biologique embarque des eaux noires",
    boatPlanNoChores: "AUCUNE CORVEE",
    boatPlanNoLicenceBoat: "bateau sans permis",
    visionGlampTitle: "Glamping sur l'eau",
    visionGlampTags: "Facile \u00b7 Leger \u00b7 Spacieux \u00b7 Ecologique",
    visionSynergiesTitle: "Synergies fluviale et terrestre",
    visionSynergiesTags: "Temps libre \u00b7 Aucune corvee \u00b7 Immersion nature",
    accountMenu: "Compte",
    bookingsMenu: "Reservations",
    profileMenu: "Profil",
    logoutMenu: "Deconnexion",
    notSignedInMenu: "Vous n'etes pas connecte.",
    signInCreateAccountMenu: "Connexion / Creer un compte",
    ...
    authPasswordPlaceholder: "••••••••",
    authChoosePasswordPlaceholder: "Choisissez un mot de passe securise",
    authGoogleSignIn: "Se connecter avec Google",
    accountHeaderTitle: "Votre compte",
    accountHeaderHelp:
      "Utilisez les onglets ci-dessous pour gerer vos reservations ou modifier votre profil.",
    profileInformation: "Informations du profil",
    profileSaved: "Profil enregistre.",
    loadingProfile: "Chargement du profil...",
    saveProfile: "Enregistrer le profil",
    saving: "Enregistrement...",
    addressNumber: "Numero d'adresse",
    reservations: "Reservations",
    noReservationsYet: "Vous n'avez pas encore de reservation.",
    filterAll: "Toutes",
    ...
    cancelReservationQuestion: "Annuler la reservation ?",
    cancelReservationBody:
      "Cette action supprimera definitivement la reservation. Elle ne peut pas etre annulee.",
    keep: "Conserver",
    cancel: "Annuler",
    cancelling: "Annulation...",
    failedToCancel: "Echec de l'annulation",
    unexpectedError: "Erreur inattendue",
    bookingSignInRequiredTitle: "Connexion requise pour reserver",
    bookingSignInRequiredBody:
      "Creez un compte ou connectez-vous avant de choisir des dates et de finaliser votre reservation.",
    goToAccount: "Aller au compte",
    bookingSignInFirst:
      "Veuillez vous connecter pour finaliser la reservation. Vos dates selectionnees seront conservees.",
    specialOffers: "Je souhaite recevoir des offres speciales",
    adults: "Adultes",
    children: "Enfants",
    completeYourProfile: "Completez votre profil",
    completeProfileBody:
      "Nous avons besoin de quelques informations avant de confirmer votre reservation.",
    fillAllRequired: "Veuillez remplir tous les champs obligatoires.",
    profileSaveFailed: "Echec de l'enregistrement du profil",
    ...
    resetPasswordRequestBody:
      "Saisissez l'email de votre compte et nous enverrons un lien securise.",
    resetEmailSent:
      "Si ce compte existe, vous recevrez un email avec les instructions de reinitialisation.",
    badRequest: "Requete incorrecte.",
    ...
    switchToLanguage: "Passer a",
    cookieBannerBody:
      "Nous utilisons des cookies pour faire fonctionner le site, mesurer son audience et ameliorer votre experience. Vous pouvez accepter tous les cookies, refuser les cookies non essentiels ou personnaliser vos choix. Consultez notre",
    ...
    necessaryCookiesBody:
      "Requis pour le fonctionnement du site et la securite. Toujours actifs.",
    analyticsCookies: "Mesure d'audience",
    analyticsCookiesBody:
      "Aide a comprendre l'utilisation du site avec des statistiques anonymisees.",
    performanceCookies: "Confort & performance",
    performanceCookiesBody:
      "Enregistre vos preferences pour ameliorer l'experience.",
    marketingCookies: "Publicite",
    marketingCookiesBody:
